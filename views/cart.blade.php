                ...
                <div class="flex flex-col w-full p-8 text-gray-800 bg-white shadow-lg pin-r pin-y md:w-4/5 lg:w-4/5">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="flex justify-between items-center my-5">
                            <div class="font-semibold text-2xl   text-blue-500 ">Total Price : {{ Cart::getTotal() }} ฿ </div>
                            <div>
                                <form action="{{ route('cart.checkout') }}" method="POST">
                                    @csrf
                                    <button class="px-6 py-2 text-sm  rounded shadow text-red-100 bg-blue-600">checkout</button>
                                </form>
